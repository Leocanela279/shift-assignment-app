...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: imageUrl, width: 1536, height: 864, alt: "Cuadra, creador gratuito de cuadrantes" }],
      locale: "es_ES",
      type: "website",
    },
    twitter: { card: "summary_large_image", title: "Cuadra", description: "Cuadrantes claros. Sin cuentas. Gratis.", images: [imageUrl] },
  };
}
